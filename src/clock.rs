pub mod clock {
    ...
    impl Clock {
        fn round_hours(minutes: i32) -> i32 {
            minutes  % MAX_DAILY_MINUTES
        }
  
        pub fn new(hours: i32, minutes: i32) -> Self {
            let hour_to_minutes = Clock::round_hours(hours * 60) + MAX_DAILY_MINUTES;
            let total_minutes = (hour_to_minutes + minutes) % MAX_DAILY_MINUTES;
            Clock{
                minutes: (total_minutes + MAX_DAILY_MINUTES) % MAX_DAILY_MINUTES
            }
        }
